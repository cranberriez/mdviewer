...
export function TreeNode({
	...
	const childDraft = draft?.mode === 'create' && draft.parentPath === entry.path ? draft : null;
	...
	return (
		<div role="treeitem" aria-expanded={entry.is_dir ? isExpanded : undefined}>
			<button
				...
				onClick={() => (entry.is_dir ? void onToggleFolder(entry) : void onSelectFile(entry))}
				...
				<div role="group">
					...
					{isLoading ? (
						<div
							...
							style={{
								paddingLeft: TREE_BASE_INDENT + TREE_LOADING_OFFSET + depth * TREE_DEPTH_INDENT,
							}}
						>
							Loading...
						</div>
