...
export type IconActionButtonTooltipPlacement = 'bottom' | 'right';
...
const tooltipBaseClasses =
	'after:pointer-events-none after:absolute after:z-[70] after:whitespace-nowrap after:rounded-md after:border after:border-border-base after:bg-bg-menu after:px-2 after:py-[3px] after:text-[11px] after:text-text-primary after:opacity-0 after:shadow-[0_6px_16px_-6px_rgba(0,0,0,.6)] after:transition after:duration-100 after:content-[attr(data-tip)] hover:after:opacity-100 hover:after:delay-[450ms]';
const tooltipPlacementClasses: Record<IconActionButtonTooltipPlacement, string> = {
	bottom:
		'after:left-1/2 after:top-[calc(100%+7px)] after:-translate-x-1/2 after:-translate-y-[3px] hover:after:translate-y-0',
	right: 'after:left-[calc(100%+7px)] after:top-1/2 after:-translate-y-1/2',
};
