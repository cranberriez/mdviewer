/**
 * Table cell resizer — vendored and adapted from Lexical's playground
 * (packages/lexical-playground/src/plugins/TableCellResizer) under the MIT
 * license. Lets the user drag a table's column-right / row-bottom edges to
 * resize. Styles live in src/lexical.css under `.TableCellResizer__*`.
 *
 * Adaptations from the original:
 * - Removed the `import './index.css'` (styles centralised in lexical.css).
