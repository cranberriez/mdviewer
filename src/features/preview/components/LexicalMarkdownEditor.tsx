...
function $readMarkdown(): string {
	return $convertToMarkdownString(MARKDOWN_TRANSFORMERS, undefined, PRESERVE_NEWLINES);
}
		...
		<LexicalComposer initialConfig={initialConfig}>
			...
			>
				...
				<RichTextPlugin
					...
					placeholder={<div className="lexical-placeholder">Start writing markdown…</div>}
